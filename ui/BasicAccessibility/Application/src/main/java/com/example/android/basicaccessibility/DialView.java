 ...
 *
 * <p>This view does not use any framework widgets, so does not get any accessibility features automatically.
 * Instead, we use {@link AccessibilityEvent} to provide accessibility hints to the OS.
 *
